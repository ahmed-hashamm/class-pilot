  ...
  return (
    <div className="space-y-2 pt-4">
      ...
      <Button
        type="button"
        variant="outline"
        className="w-full py-3 text-xs font-bold border-slate-200 rounded-xl hover:bg-slate-50/80 hover:border-slate-300 transition-all duration-300 gap-2 group"
      ...
      >
        ...
        {loading ? 'Authorizing...' : 'Continue with Google Account'}
      </Button>
    </div>
  )
}
