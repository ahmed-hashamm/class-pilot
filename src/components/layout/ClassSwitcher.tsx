      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed left-4 right-4 top-[60px] sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-3 sm:w-72 bg-white border border-border shadow-[0_40px_80px_rgba(0,0,0,0.25)] rounded-2xl overflow-hidden z-[9999]"
          >
