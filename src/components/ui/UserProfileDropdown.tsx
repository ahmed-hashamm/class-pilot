...
export function UserProfileDropdown({ profile, onSignOut }: UserProfileDropdownProps) {
  ...
  return (
    <div ref={dropdownRef} className="relative">
      ...
      {/* Profile Dropdown */}
      {isOpen && (
        <div className="absolute right-0 top-12 w-72 max-w-[calc(100vw-2rem)] bg-white text-gray-800 rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-100">
          {/* User Info Header */}
