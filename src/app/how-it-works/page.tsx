...
function DiagramCreateClass() {
  return (
    <svg viewBox="0 0 260 180" fill="none" className="w-full">
      ...
      <text x="88" y="88" fontFamily="Inter,sans-serif" fontSize="7.5" fill={MUTED_TEXT}>Grade 9 · Biology</text>
...
function DiagramPostAssignment() {
  return (
    <svg viewBox="0 0 260 185" fill="none" className="w-full">
      ...
      <text x="30" y="59" fontFamily="Inter,sans-serif" fontSize="8.5" fill={NEAR_BLACK}>Cell Division Quiz — Chapter 4</text>
      {/* instructions */}
      ...
      {/* CTA */}
      <rect x="22" y="146" width="216" height="20" rx="5" fill={YELLOW}/>
...
function DiagramGrading() {
  const rows = [
    { name: "Aisha K.", score: "18/20", bar: 0.9,  ai: true  },
    { name: "James T.", score: "14/20", bar: 0.7,  ai: true  },
    { name: "Priya S.", score: "—",     bar: 0,    ai: false },
  ];
  return (
  ...
  return (
    <>
      ...
      <main className="bg-background text-foreground font-sans overflow-x-hidden">
        ...
        {/* ── HERO  (navy bg) ─────────────────────────────────────────────── */}
        <section className="relative bg-navy text-white text-center px-6 pt-28 pb-24 overflow-hidden">
          {/* subtle radial glow */}
          ...
          <h1 className="cp-hero-2 font-black text-[clamp(36px,6vw,70px)] leading-[1.06]
        ...
        <section className="py-20 bg-background">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="flex flex-col">
              {steps.map((step, i) => (
                <div key={`${view}-${i}`}
                  className={`cp-reveal grid items-stretch min-h-[240px]
                    grid-cols-1 md:grid-cols-[1fr_60px_1fr]
                    ${step.flip ? "md:[&_.sc]:order-3 md:[&_.sp]:order-2 md:[&_.sv]:order-1" : ""}`}
                  style={{ transitionDelay: step.delay }}>

                  {/* content */}
                  <div className={`sc flex flex-col justify-center py-10 px-4 md:px-6
                  ...
                  {/* spine */}
                  <div className="sp hidden md:flex flex-col items-center">
                  ...
                  {/* visual */}
                  <div className="sv flex items-center justify-center p-4 md:p-6">
